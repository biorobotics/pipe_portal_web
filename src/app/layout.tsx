/**
 * @fileoverview Main layout for the application.
 * Contains the header, left navigation bar, and main content area.
 * Uses Geist and Roboto fonts for styling.
 ...
 * @returns - The root layout component with header and sidebar
 */
        ...
        <NavigationProvider>
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", position: "absolute", left: 32, top: 0, bottom: 0, height: "100%" }}>
              {/* <img src="/assets/logo.png" alt="Carnegie Mellon University Logo" style={{ height: 40, width: "auto" }} /> */} {/* CMU biorobotics logo */ } 
              <img src="assets/pf-logo.svg" height="43" width="239" /> {/* Pipe Force logo */}
            </div>
            {/* Breadcrumbs */}
